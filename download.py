...
from create_classes import get_classes
...
def main(args):
    ...
    if args.all:
        ...
        download_classes(get_classes(), args.num_workers, args.failed_log, args.compress, args.verbose, args.skip,
                         args.log_file)
        ...
        if args.test:
            # download the test set
            download_test_set(args.num_workers, args.failed_log, args.compress, args.verbose, args.skip,
                              args.failed_log)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--compress", default=False, action="store_true",
                        help="compress videos using gzip (not recommended)")
    ...
    parser.add_argument("-s", "--skip", default=False, action="store_true",
                        help="skip classes that already have folders")
    parser.add_argument("-l", "--log-file",
                        help="log file for youtube-dl (the library used to download YouTube videos)")
